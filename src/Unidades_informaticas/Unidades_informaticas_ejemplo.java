...
public class Unidades_informaticas_ejemplo {
    ...
    public Unidades_informaticas_ejemplo() { //CONSTRUCTOR VACIO
        this.opcioni = 0;
        this.opcionf = 0;
        this.cantidad = 0.0;
    }

    public Unidades_informaticas_ejemplo(int opcioni, int opcionf, double cantidad) { //CONSTRUCTOR CON TODOS LOS ATRIBUTOS
    ...
    public String toString() {
        return "UnidadesInformatica{" + "opcioni=" + opcioni + ", opcionf=" + opcionf + ", cantidad=" + cantidad + '}'; // el = era te imprime el valor asignado
    }

...
public class Util {
    ...
    public static int leerEdad() {
        ...
        String patron = "[0-9]+";  //[1-150]     8888888
        boolean correcto;  // creamos una bandera
        String edad;
        do {
    ...
    public static boolean existeAsignatura(String asignatura, List<String> alumnosaux_al) {
        boolean exite = false;
        for(String s: alumnos_al) {
            if(s.equals(asignatura)) {
                existe = true;
                break;  //rompe el bucle del for
            }
        }
        return existe;
    }

...
public class VentanaAgenda1_1 extends javax.swing.JFrame {

    //BASE DE DATOS
    List<Persona1> personas_al = new ArrayList<>();
    
    
    public VentanaAgenda1_1() {
        initComponents();
        personalizarVentana();
        cargarBaseDatos();
        txtIndice.setText("0");
    ...
    public void pintarLabel(String nombreFoto) {
        try {
            BufferedImage imagenOriginal = ImageIO.read(new File("imagenes2/" + nombreFoto + ".png"));
